...
return [
    ...
    'schemas' => [
        ...
        'auth' => [
            ...
            'mutation' => [
                ...
                "addArticle"=>\App\GraphQL\Mutations\AddArticle::class,
                "deleteUser"=>\App\GraphQL\Mutations\DeleteUser::class,
                "deleteArticle"=>\App\GraphQL\Mutations\DeleteArticle::class,
                "editUser"=>\App\GraphQL\Mutations\EditUser::class,
                "editArticle"=>\App\GraphQL\Mutations\EditArticle::class,
            ],
    ...
    // facade like this: GraphQL::type('user.jsx')
    //
    // Example:
    //
    // 'types' => [
    //     'user.jsx' => 'App\GraphQL\Type\UserType'
    // ]
    //
    'types' => [
